 ...
 * 
 */
@WebServiceClient(name = "RPNCalculatorService", targetNamespace = "http://amdocs.com", wsdlLocation = "http://localhost:8080/RPNCalculatorSOAP/services/RPNCalculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/RPNCalculatorSOAP/services/RPNCalculator?wsdl");
